{ ... }: {
  flake.modules.homeManager.casper-gnome =
    { config, lib, hostname, username, pkgs, ... }:
    let cfg = config.roles.gnome;
    in 
    {
    #  options.roles.gnome = {
    ...
    #    # Path for ddcutil
    #    home.file.".local/share/ddcutil/bin/ddcutil".source =
    ...
    #        picture-uri =
    #          "file:///home/${username}/lkasper-flake/wallpapers/wallpaper.jpg";
    #        picture-uri-dark =
    #          "file:///home/${username}/lkasper-flake/wallpapers/wallpaper.jpg";
    #      };
    ...
    #        button-location = 1;
    #        ddcutil-binary-path =
    #          "/home/${username}/.local/share/ddcutil/bin/ddcutil";
    #        tray-pos = "right";
