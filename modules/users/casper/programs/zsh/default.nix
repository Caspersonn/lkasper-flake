{ ... }: {
  flake.modules.homeManager.casper-zsh = { config, ... }: {
    home.file = {
      ".ohmyzsh-casper" = {
    ...
    programs.zsh = {
      ...
      shellAliases = {
        ...
        tses = "$HOME/lkasper-flake/modules/users/casper/programs/tmux/script/sessionizer.sh";
      ...
      oh-my-zsh = {
        ...
        plugins = [ "git" "aws" "fzf" "autojump" "dirhistory" "terraform" ];
      };
    };
  };
}
