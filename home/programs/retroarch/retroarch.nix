...
let
  ...
  libretroCores = "${pkgs.retroarch}/lib/retroarch/cores";
  libretroInfo = "${pkgs.libretro-core-info}/share/retroarch/cores";
in {
  home.file = {
    ".config/retroarch/retroarch.cfg".text = ''
      ...
      assets_directory = "${retroarchAssets}"
      ...
      custom_viewport_height = "1620"
      custom_viewport_width = "1350"
      custom_viewport_x = "0"
      custom_viewport_y = "0"
      ...
      kiosk_mode_password = ""
      led_driver = "null"
      libretro_directory = "${libretroCores}"
      libretro_info_path = "${libretroInfo}"
      ...
      menu_wallpaper = "${retroarchAssets}/wallpapers/posterized consoles/1440x900/Cave Story.png"
